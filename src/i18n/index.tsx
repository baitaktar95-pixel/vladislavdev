...
const translations: Record<Lang, Dict> = {
  ru: {
    ...
    "services.web.title": "Сайты и лендинги в Тирасполе, Кишинёве и Молдове",
    "services.web.desc": "Современные адаптивные сайты с продуманным UX. Создание сайтов в Тирасполе и Кишинёве — от лендингов до корпоративных ресурсов. Заказать сайт в Молдове недорого и быстро.",
    "services.bot.title": "Telegram-боты для бизнеса в Молдове",
    "services.bot.desc": "Telegram-боты для бизнеса в Молдове. Автоматизация бизнеса: боты для продаж, поддержки клиентов, интеграций с CRM и платежами.",
    "services.ai.title": "AI-решения для компаний в Тирасполе и Кишинёве",
    "services.ai.desc": "AI-решения для компаний в Тирасполе и Кишинёве. GPT-чат-боты, AI-ассистенты и автоматизация процессов для бизнеса в Молдове.",
    "services.agent.title": "AI-агенты для бизнеса в Тирасполе и Молдове",
    "services.agent.desc": "AI-агенты, которые работают за вас: сами отвечают клиентам, обрабатывают заявки, ведут CRM и автоматизируют рутину 24/7. Разработка AI-агентов в Кишинёве и Молдове.",
    ...
    "reviews.subtitle": "Что говорят о работе предприниматели из Кишинёва, Тирасполя, Бендер и других городов Молдовы.",
    ...
    "footer.tagline": "Vladislav · Веб разработчик Кишинев · Сайты, Telegram-боты и AI-решения в Молдове",
    ...
    "blog.title2": "статьи",
    "blog.subtitle": "Делюсь опытом и советами о сайтах, Telegram-ботах и AI-решениях для бизнеса в Кишинёве, Тирасполе и по всей Молдове.",
    "blog.read": "Читать",
    "blogPost.back": "Назад к статьям",
    "blogPost.region": "Молдова",
    "blogPost.likeHint": "Понравилась статья? Поставьте лайк",
    "blogPost.ctaKicker": "Готовы начать?",
    "blogPost.ctaTitle": "Обсудим ваш проект в Молдове",
  ...
  en: {
    ...
    "services.agent.title": "AI agents for business in Tiraspol & Transnistria",
    "services.agent.desc": "AI agents that work for you: reply to clients, process leads, manage CRM and automate routine 24/7. AI agent development in Transnistria and Moldova.",
  ...
  ro: {
    ...
    "services.agent.title": "Agenți AI pentru afaceri în Tiraspol și Transnistria",
    "services.agent.desc": "Agenți AI care lucrează pentru tine: răspund clienților, procesează solicitări, gestionează CRM și automatizează rutina 24/7. Dezvoltare agenți AI în Transnistria și Moldova.",
