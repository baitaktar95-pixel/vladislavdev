...
const translations: Record<Lang, Dict> = {
  ru: {
    ...
    "services.agent.title": "AI-агенты для бизнеса в Тирасполе и ПМР",
    "services.agent.desc": "AI-агенты, которые работают за вас: сами отвечают клиентам, обрабатывают заявки, ведут CRM и автоматизируют рутину 24/7. Разработка AI-агентов в ПМР и Молдове.",
