...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://vladislavbdev.com/" },
      { property: "og:image", content: "https://vladislavbdev.com/favicon.png" },
      ...
      { name: "twitter:image", content: "https://vladislavbdev.com/favicon.png" },
    ],
    links: [
      { rel: "canonical", href: "https://vladislavbdev.com/" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://vladislavbdev.com/",
          telephone: "+37360595340",
          image: "https://vladislavbdev.com/favicon.png",
          priceRange: "$$",
